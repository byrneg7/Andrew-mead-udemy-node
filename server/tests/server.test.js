...
//clear the database and add dummy documents
...
describe('GET /todos', () => {
    it('should get todos for user1', (done) => {
        request(app)
            .get('/todos')
            .set('x-auth', users[0].tokens[0].token)
            .expect(200)
...
describe('Delete /todos/id:', () => {
    ...
    it('shouldn\'t remove a todo belonging to other user', (done) => {
